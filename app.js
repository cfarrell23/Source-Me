...
app.post("/", function(req, res) {
  ...
  switch (projectRoleId) {
    case 1:
      ...
      var resourceManagerName = exampleRoleArray[projectRoleId - 1].resourceManagerName;
      var resourceManagerEmail = exampleRoleArray[projectRoleId - 1].resourceManagerEmail;
      break;
    case 2:
      var projectName = exampleRoleArray[projectRoleId - 1].projectName;
      var client = exampleRoleArray[projectRoleId - 1].client;
